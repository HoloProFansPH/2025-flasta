    ...
    return(
        <div className="card">
            ...
            <div className="tableFlex">
                ...
                <ProjectItem title="♾️ Octavio's Ice Cream Cart" link="https://twitter.com/Octavicord/status/1957357331668242528" description="An Octoposse Fundraising Fan Project for Cosmania by PH Octoposse"/>
            </div>
        </div>
    );
}
